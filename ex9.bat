...
"%PYTHON%" -c "from pathlib import Path; p=Path('helloworld_project/settings.py'); s=p.read_text(encoding='utf-8'); s=s.replace('    '+chr(39)+'pages'+chr(39)+','+chr(10),'').replace('    '+chr(34)+'pages'+chr(34)+','+chr(10),''); s=s.replace('INSTALLED_APPS = [', 'INSTALLED_APPS = ['+chr(10)+'    '+chr(39)+'pages'+chr(39)+',', 1); s=s.replace(chr(39)+'DIRS'+chr(39)+': []', chr(39)+'DIRS'+chr(39)+': [BASE_DIR / '+chr(39)+'pages/templates'+chr(39)+']').replace(chr(34)+'DIRS'+chr(34)+': []', chr(34)+'DIRS'+chr(34)+': [BASE_DIR / '+chr(34)+'pages/templates'+chr(34)+']'); p.write_text(s, encoding='utf-8')" >> "%LOG%" 2>&1
if errorlevel 1 exit /b 1
